...
스레드를 사용해 오픈 시간 이후 티켓팅 가능 / 좌석표 동적으로 비활성화 하여 실제 티켓팅 연습을 할 수 있도록 구현 </br>
...
2) 난이도에 따라 사라지는 속도가 다른
3) 선택한 좌석은 노란색으로 변경되며, 우측에 바로 반영되어 출력
